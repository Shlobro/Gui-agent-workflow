...
- Claude provider: Opus 4, Sonnet 4, Haiku 3.5. The provider uses Anthropic's stable Claude model aliases so the UI does not drift behind minor model refreshes.
